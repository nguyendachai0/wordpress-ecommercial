...
function wp_site_icon()
{
	...
	if (empty($icon_32) && is_customize_preview()) {
		$icon_32 = 'http://localhost/haindpd07304/wp-content/uploads/2021/01/logo1.png'; // Serve default favicon URL in customizer so element can be updated for preview.
	}
	if ($icon_32) {
